...
class HydrotreaterDummyCellsTest {
    private static final int[] DIM = {6, 0, 1, 1, 1, 1};

    @Test
    void footprintIsThreeByThreeBySevenAndCornersExist() {
        assertEquals(62, MultiblockHandlerXR.cellCount(DIM, DummyableMeta.SOUTH));
