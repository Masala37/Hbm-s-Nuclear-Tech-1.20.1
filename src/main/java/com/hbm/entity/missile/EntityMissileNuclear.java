...
public class EntityMissileNuclear extends EntityMissileTier4 {
    ...
    public EntityMissileNuclear(Level level) {
        this(ModEntities.MISSILE_NUCLEAR.get(), level);
    }

    public EntityMissileNuclear(Level level, double x, double y, double z,
                                int targetX, int targetY, int targetZ) {
        super(ModEntities.MISSILE_NUCLEAR.get(), level, x, y, z, targetX, targetY, targetZ);
    }
