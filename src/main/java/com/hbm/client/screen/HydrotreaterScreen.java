...
public class HydrotreaterScreen extends AbstractContainerScreen<HydrotreaterMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(RefStrings.MODID, "textures/gui/processing/gui_hydrotreater.png");

    public HydrotreaterScreen(HydrotreaterMenu menu, Inventory inv, Component title) {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        drawTank(graphics, x + 53, y + 18, 16, 52, be.getHydrogen().getFluid(),
                be.getHydrogen().getFluidAmount(), be.getHydrogen().getCapacity());
        drawTank(graphics, x + 125, y + 18, 16, 52, be.getOutput1().getFluid(),
                be.getOutput1().getFluidAmount(), be.getOutput1().getCapacity());
        drawTank(graphics, x + 143, y + 18, 16, 52, be.getOutput2().getFluid(),
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        } else if (isHovering(53, 18, 16, 52, mouseX, mouseY)) {
            tooltipTank(graphics, be.getHydrogen().getFluid(), be.getHydrogen().getFluidAmount(),
                    be.getHydrogen().getCapacity(), mouseX, mouseY);
