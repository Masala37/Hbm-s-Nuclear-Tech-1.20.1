...
/**
 * 1.7.10 {@code RenderCentrifuge} for {@code TileEntityMachineCentrifuge}.
 */
public class RenderCentrifuge implements BlockEntityRenderer<CentrifugeBlockEntity> {
    public static final ResourceLocation MODEL =
            new ResourceLocation(RefStrings.MODID, "block/centrifuge");
    ...
    @Override
    public void render(CentrifugeBlockEntity be, float partialTick, PoseStack pose,
