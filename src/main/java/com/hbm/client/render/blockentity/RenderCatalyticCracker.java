...
/**
 * 1.7.10 {@code RenderCatalyticCracker}.
 */
public class RenderCatalyticCracker implements BlockEntityRenderer<CatalyticCrackerBlockEntity> {
    public static final ResourceLocation MODEL =
            new ResourceLocation(RefStrings.MODID, "block/catalytic_cracker");

    public static List<ResourceLocation> allModels() {
        return List.of(MODEL);
    }

    public RenderCatalyticCracker(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(CatalyticCrackerBlockEntity be, float partialTick, PoseStack pose,
    ...
    @Override
    public boolean shouldRenderOffScreen(CatalyticCrackerBlockEntity be) {
        return true;
    }
