...
/**
 * 1.7.10 {@code RenderWoodBurner}. OBJ origin is the core corner, not the block center.
 */
public class RenderWoodBurner implements BlockEntityRenderer<WoodBurnerBlockEntity> {
    public static final ResourceLocation MODEL =
            new ResourceLocation(RefStrings.MODID, "block/wood_burner");
    ...
    @Override
    public void render(WoodBurnerBlockEntity be, float partialTick, PoseStack pose,
    ...
    @Override
    public boolean shouldRenderOffScreen(WoodBurnerBlockEntity be) {
        return true;
    }
