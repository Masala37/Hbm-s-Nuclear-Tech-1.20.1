...
/**
 * 1.7.10 {@code RenderSolderingStation}.
 */
public class RenderSolderingStation implements BlockEntityRenderer<SolderingStationBlockEntity> {
    public static final ResourceLocation MODEL =
            new ResourceLocation(RefStrings.MODID, "block/soldering_station");
    ...
    @Override
    public void render(SolderingStationBlockEntity be, float partialTick, PoseStack pose,
    ...
    @Override
    public boolean shouldRenderOffScreen(SolderingStationBlockEntity be) {
        return true;
    }
