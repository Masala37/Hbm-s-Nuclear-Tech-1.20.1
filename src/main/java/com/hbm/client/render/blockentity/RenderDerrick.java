...
/**
 * 1.7.10 {@code RenderDerrick}.
 */
public class RenderDerrick implements BlockEntityRenderer<OilWellBlockEntity> {
    public static final ResourceLocation MODEL =
            new ResourceLocation(RefStrings.MODID, "block/derrick");

    public static List<ResourceLocation> allModels() {
        return List.of(MODEL);
    }

    public RenderDerrick(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(OilWellBlockEntity be, float partialTick, PoseStack pose,
    ...
    @Override
    public boolean shouldRenderOffScreen(OilWellBlockEntity be) {
        return true;
    }
