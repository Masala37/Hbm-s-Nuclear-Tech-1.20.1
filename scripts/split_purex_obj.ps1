...
$src = Join-Path $root "src/main/resources/assets/hbm/models/legacy_raw/machines/purex.obj"
...
$itemParts = @($byName["Base"], $byName["Frame"], $byName["Fan"], $byName["Pump"])
Emit-Parts $itemParts "purex.mtl" "purex"
Write-Utf8NoBom (Join-Path $blockDir "machine_purex.json") (Block-Json "purex")
Write-Host "done"
