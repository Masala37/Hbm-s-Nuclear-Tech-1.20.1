...
$src = Join-Path $root "src/main/resources/assets/hbm/models/legacy_raw/machines/wood_burner.obj"
...
$tex = "hbm:models/machines/wood_burner"
...
if (-not $byName.ContainsKey("Cylinder")) { throw "missing object Cylinder" }
Emit-Object $byName["Cylinder"] "wood_burner.mtl" "wood_burner" $tex $mtlBody

Write-Utf8NoBom (Join-Path $blockDir "machine_wood_burner.json") (Block-Json "wood_burner" $tex)
Write-Utf8NoBom (Join-Path $blockDir "wood_burner_dummy.json") @"
{
  "parent": "minecraft:builtin/entity",
  "textures": { "particle": "hbm:models/machines/wood_burner" }
}
"@
Write-Host "done"
