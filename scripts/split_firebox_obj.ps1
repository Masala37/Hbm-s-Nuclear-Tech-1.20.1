...
$src = Join-Path $root "src/main/resources/assets/hbm/models/legacy_raw/machines/firebox.obj"
...
$tex = "hbm:models/machines/firebox"
...
$tesr = [ordered]@{
  Main = "firebox_main"
  Door = "firebox_door"
  InnerBurning = "firebox_inner_burning"
  InnerEmpty = "firebox_inner_empty"
}
...
[void]$itemLines.Add("mtllib firebox_item.mtl")
...
Assert-Faces $itemText "firebox_item"
Write-Utf8NoBom (Join-Path $outDir "firebox_item.obj") $itemText
Write-Utf8NoBom (Join-Path $outDir "firebox_item.mtl") $mtlBody
Write-Utf8NoBom (Join-Path $blockDir "heater_firebox.json") (Block-Json "firebox_item" $tex)
Write-Host "firebox_item.obj objects $($itemParts.Count) verts $($usedV.Count)"
Write-Host "done"
