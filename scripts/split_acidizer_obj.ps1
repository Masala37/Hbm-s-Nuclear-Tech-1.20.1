...
$src = Join-Path $root "src/main/resources/assets/hbm/models/legacy_raw/machines/acidizer.obj"
...
$tex = "hbm:models/machines/acidizer"
$mtlBody = "newmtl material`nKd 1 1 1`nmap_Kd $tex`n"
$utf8 = New-Object System.Text.UTF8Encoding $false

$tesr = [ordered]@{
  Fluid = "acidizer_fluid"
  Spinner = "acidizer_spinner"
  Body = "acidizer_body"
}
...
$itemParts = @($byName["Body"], $byName["Spinner"])
Emit-Parts $itemParts "acidizer.mtl" "acidizer"
Write-Utf8NoBom (Join-Path $blockDir "machine_crystallizer.json") (Block-Json "acidizer")
Write-Host "done"
