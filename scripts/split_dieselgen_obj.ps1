...
$src = Join-Path $root "src/main/resources/assets/hbm/models/legacy_raw/machines/dieselgen.obj"
...
$tex = "hbm:models/machines/dieselgen"
$mtlBody = "newmtl material`nKd 1 1 1`nmap_Kd $tex`n"
$utf8 = New-Object System.Text.UTF8Encoding $false

$tesr = [ordered]@{
  Generator = "dieselgen_generator"
  Engine = "dieselgen_engine"
}
...
[void]$itemLines.Add("mtllib dieselgen_item.mtl")
...
Assert-Faces $itemText "dieselgen_item"
Write-Utf8NoBom (Join-Path $outDir "dieselgen_item.obj") $itemText
Write-Utf8NoBom (Join-Path $outDir "dieselgen_item.mtl") $mtlBody
Write-Utf8NoBom (Join-Path $blockDir "diesel_generator.json") (Block-Json "dieselgen_item" $tex)
Write-Host "dieselgen_item.obj objects $($itemParts.Count) verts $($usedV.Count)"
Write-Host "done"
