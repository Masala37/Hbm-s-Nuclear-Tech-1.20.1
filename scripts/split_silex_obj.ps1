...
$src = Join-Path $root "src/main/resources/assets/hbm/models/legacy_raw/machines/silex.obj"
...
Emit-Parts @($byName["Cube_Cube.001"]) "silex.mtl" "silex"
Write-Utf8NoBom (Join-Path $blockDir "machine_silex.json") (Block-Json "silex")
Write-Host "done"
