...
$src = Join-Path $root "src/main/resources/assets/hbm/models/legacy_raw/machines/fel.obj"
...
Emit-Parts @($byName["Cube_Cube.001"]) "fel.mtl" "fel"
Write-Utf8NoBom (Join-Path $blockDir "machine_fel.json") (Block-Json "fel")
Write-Host "done"
