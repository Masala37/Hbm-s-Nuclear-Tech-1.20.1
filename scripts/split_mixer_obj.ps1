...
$src = Join-Path $root "src/main/resources/assets/hbm/models/legacy_raw/machines/mixer.obj"
...
$itemParts = @($byName["Main"], $byName["Mixer"])
Emit-Parts $itemParts "mixer.mtl" "mixer"
Write-Utf8NoBom (Join-Path $blockDir "machine_mixer.json") (Block-Json "mixer")
Write-Host "done"
