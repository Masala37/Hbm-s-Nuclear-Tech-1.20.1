...
$src = Join-Path $root "src/main/resources/assets/hbm/models/legacy_raw/machines/arc_welder.obj"
...
$tex = "hbm:models/machines/arc_welder"
...
if (-not $byName.ContainsKey("Plane")) { throw "missing object Plane" }
Emit-Parts @($byName["Plane"]) "arc_welder.mtl" "arc_welder"
Write-Utf8NoBom (Join-Path $blockDir "machine_arc_welder.json") (Block-Json "arc_welder")
Write-Host "done"
